...
@[The spread operator can also be used with objects to extend an original object whilst creating a new reference:]({ "stubs": ["objectSpread.js"], "command": "node_modules/mocha/bin/babel-node objectSpread.js" })
